...
def main(geracao,tamanhopop,tamanhoindividuo,taxadecruzamento, taxamutacao):
	pop_atual = criarpop(tamanhopop,tamanhoindividuo)
	individuomaisapto = []
	for i in range(0, geracao):
		...
		# print('\n')
		# print(popavaliada)
	return (pop_atual, individuomaisapto)
...
def media(ensaio1, ensaio2, ensaio3,ensaio4, ensaio5, ensaio6,ensaio7, ensaio8, ensaio9,ensaio10, ensaio11, ensaio12,ensaio13, ensaio14, ensaio15,ensaio16, ensaio17, ensaio18,ensaio19, ensaio20, ensaio21,ensaio22, ensaio23, ensaio24,ensaio25, ensaio26, ensaio27,ensaio28, ensaio29, ensaio30):
	media = []
...
media = media(aux0,aux1,aux2,aux3,aux4,aux5,aux6,aux7,aux8,aux9,aux10,aux11,aux12,aux13,aux14,aux15,aux16,aux17,aux18,aux19,aux20,aux21,aux22,aux23,aux24,aux25,aux26,aux27,aux28,aux29)
...
# pop_final3 = main(geracao,tamanhopop,tamanhoindividuo,taxadecruzamento,taxamutacao)[0]
# individuomaisapto3 = main(geracao,tamanhopop,tamanhoindividuo,taxadecruzamento,taxamutacao)[1]
# ensaio3 = individuomaisapto3

# media = media(ensaio1,ensaio2,ensaio3)

# fig, (ax0,ax1,ax2,ax3) = plt.subplots(nrows = 4)

# ax0.plot(individuomaisapto, 'b-')
# ax0.set_title('Individuo mais Apto ensaio 1')

# ax1.plot(individuomaisapto2, 'r-')
# ax1.set_title('Individuo mais Apto ensaio 2')

# ax2.plot(individuomaisapto3, 'y-')
# ax2.set_title('Individuo mais Apto ensaio 3')

# ax3.plot(media, 'g')
# ax3.set_title('Media dos Individuos Mais Aptos')
